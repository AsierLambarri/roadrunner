...
class TestConstructor:
    def test_basic_attributes(self):
        ...
        halo = HaloModel(inner, xcen, sub_tree_id=42, redshift=0.5)
    ...
    def test_non_comoving(self):
        inner = KeplerPotential(M=1e12)
        halo = HaloModel(inner, np.zeros(3), sub_tree_id=1, redshift=0.5, comoving=False)
...
class TestPotential:
    ...
    def test_nfw_comoving(self):
        ...
        halo = HaloModel(inner, np.zeros(3), sub_tree_id=1, redshift=3.0)
